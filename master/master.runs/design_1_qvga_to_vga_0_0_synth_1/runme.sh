...
HD_PWD='/home/shohei/Downloads/todotani_ov7670/master/master.runs/design_1_qvga_to_vga_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_qvga_to_vga_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_qvga_to_vga_0_0.tcl
